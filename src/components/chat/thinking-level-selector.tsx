...
export function ThinkingLevelSelector() {
  ...
  const { selectedModelId, thinkingLevel, setThinkingLevel, isGenerating } = useChatStore()
            ...
            <DropdownMenuTrigger asChild>
              <Button
                ...
                className={cn(
                  ...
                  thinkingLevel === 'low' && 'border-green-500/50 bg-green-50 hover:bg-green-100 dark:border-green-500/30 dark:bg-green-950/30 dark:hover:bg-green-950/50',
                  thinkingLevel === 'medium' && 'border-blue-500/50 bg-blue-50 hover:bg-blue-100 dark:border-blue-500/30 dark:bg-blue-950/30 dark:hover:bg-blue-950/50',
                  thinkingLevel === 'high' && 'border-purple-500/50 bg-purple-50 hover:bg-purple-100 dark:border-purple-500/30 dark:bg-purple-950/30 dark:hover:bg-purple-950/50'
                )}
              >
            ...
            >
              <div
                className={cn(
                  ...
                  level === 'low' && 'bg-green-100 dark:bg-green-900/50',
                  level === 'medium' && 'bg-blue-100 dark:bg-blue-900/50',
                  level === 'high' && 'bg-purple-100 dark:bg-purple-900/50'
                )}
              >
